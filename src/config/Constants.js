...
export const PERSONAS_DATA = {
  "The Captivating Creator": {
    ...
    description: [
      'Traits: As "The Captivating Creator," you possess a unique skill for capturing meeting highlights through creative comics or memes. 🎨✏️ Your creative flair brings meetings to life, leaving a lasting impression on participants and keeping everyone engaged. Your summaries are not only informative but also visually captivating, making them memorable and easily understood. 📝💡',
      'Collaborating with "The Super Productive Prodigy" is a match made in productivity heaven, as your creative highlights perfectly complement their efficiency-driven mindset. Together, you create a dynamic duo that combines creativity with tangible results, making meetings both engaging and productive. 💼🎨🚀',
